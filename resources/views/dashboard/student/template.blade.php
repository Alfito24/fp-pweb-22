...
<head>
  ...
  <link rel="icon" href="{{ asset('images/logo-update.png')}}">
   <!-- Line Chart -->
...
<body class="hold-transition sidebar-mini layout-fixed">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="/dashboard_user/create_request" class="nav-link">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2022 <a href="http://adminlte.io">Si Dita</a>.</strong>
    All rights reserved.
