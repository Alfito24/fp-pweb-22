...
<table class="table">
  ...
  <section >
  <form class="d-flex flex-column" style="margin-bottom: 20px;" action="/acceptdospeng/{{ $request->id }}" method="POST">
    @csrf
    <button type="submit" class="btn btn-success">Accept</button>
 </form>
</section >
<section >
 <form class="d-flex flex-column" action="/rejectdospeng/{{ $request->id }}" method="POST">
  @csrf
